...
--
DELIMITER $$
CREATE TRIGGER `logintime` AFTER INSERT ON `login` FOR EACH ROW INSERT INTO logs_student VALUES(NULL,NEW.USN,"INSERTED",NOW())
$$
DELIMITER ;
...
--
-- Table structure for table `logs_student`
--
...
--
-- Dumping data for table `logs_student`
--

INSERT INTO `logs_student` (`logs_id`, `USN`, `action`, `time`) VALUES
(1, '4SF21CS032', 'INSERTED', '2024-03-17 12:23:02');

-- --------------------------------------------------------

--
-- Table structure for table `logs_ws`
--
...
('WS1', 'OFFLINE', 'AI ESSENTIALS', '09:00:00', '2023-03-07', 'G_FLOOR SEMINAR HALL', 'D1', NULL, 'C17'),
('WS2', 'OFFLINE', 'Tech Unleashed: From readiness to AI future', '11:00:00', '2024-01-05', 'G_FLOOR SEMINAR HALL', 'D1', NULL, 'C15'),
('WS3', 'OFFLINE', 'Mastering Software Development Life Cycle: Mini Pr', '09:30:00', '2023-03-07', 'G_FLOOR SEMINAR HALL', 'D1', NULL, 'C16'),
('WS4', 'OFFLINE', 'Process Innovation: Understanding technology readi', '14:00:00', '2024-02-14', 'G_FLOOR SEMINAR HALL', 'D1', 'P1', 'C4'),
('WS5', 'OFFLINE', 'Strategic Synergy of Creativity: Design thinking, ', '14:00:00', '2024-02-02', 'G_FLOOR SEMINAR HALL', 'D1', NULL, 'C11'),
('WS6', 'OFFLINE', 'Automating Tomorrow: Navigating the landscape of r', '14:00:00', '2024-01-31', 'G_FLOOR SEMINAR HALL', 'D1', NULL, 'C5'),
('WS7', 'OFFLINE', 'Strategic Tech Fusion: Unlocking the power of prob', '10:30:00', '2024-01-25', 'G_FLOOR SEMINAR HALL', 'D1', NULL, 'C7');
...
--
-- Indexes for table `logs_student`
--
ALTER TABLE `logs_student`
  ADD PRIMARY KEY (`logs_id`);

--
-- Indexes for table `logs_ws`
--
ALTER TABLE `logs_ws`
...
--
-- AUTO_INCREMENT for table `logs_student`
--
ALTER TABLE `logs_student`
  MODIFY `logs_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `logs_ws`
--
ALTER TABLE `logs_ws`
...
--
ALTER TABLE `login`
  ADD CONSTRAINT `FKUSN` FOREIGN KEY (`USN`) REFERENCES `student` (`USN`);
